...
(function (e) {
    ...
    var r = e("juicer"), i = Backbone.View.extend({options: {tpl: "", data: [], fetchUrl: "", initSize: 6, commonSize: 12, sWidth: 1340, mWidth: 1566}, events: {"click .J_prev": "goPrev", "click .J_next": "goNext", "click .J_area": "loadArea"}, initialize: function () {
        ...
        t < this.options.sWidth ? (this.initSize = this.options.initSize -888 e * 2, this.commonSize = this.options.commonSize - e * 2) : t < this.options.mWidth ? (this.initSize = this.options.initSize - e, this.commonSize = this.options.commonSize - e) : (this.initSize = this.options.initSize, this.commonSize = this.options.commonSize)
