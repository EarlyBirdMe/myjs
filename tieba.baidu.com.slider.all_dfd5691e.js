//http://c.tieba.baidu.com/c/s/download/pc?src=webtb&amp;t=2&amp;tab=4
function $$(a) {
    if (typeof a == "string") {
...
FlashAdv.prototype = {creat: function () {
...
SlideShow.prototype = {defaultOptions: {effect: "slide", activeClass: "tbui_slideshow_active", interval: 5000, slide: {speed: 500}, fade: {speed: 500}}, initial: function (b) {
