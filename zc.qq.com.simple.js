...
$.cookie = {get: function (a) {
    ...
    document.cookie = a + "=; expires=Mon, 26 Jul 1997 05:00:00 GMT; path=" +
        (c ? c : "/") + "; " + (b ? "domain=" + b + ";" : "")
}, clear: function () {
    var a = document.cookie.match(RegExp("([^ ;][^;]*)(?=(=[^;]*)(;|$))", "gi")), b;
    ...
    if (!b || b == "undefined")a == 1 && $.report.monitor("no_uin"),
...
$.http = {getXHR: function () {
    ...
    if (e)e.open(d, a), e.onreadystatechange = function () {
        if (e.readyState == 4 && (e.status >= 200 && e.status < 300 || e.status === 304 || e.status === 1223 || e.status === 0))typeof f == "undefined" ? c(eval("(" + e.responseText + ")")) : c(e.responseText), e.onreadystatechange = function () {
        }, e = null
    }, e.send(b)
},
    post: function (a, b, c, d) {
        ...
        c.onload = c.onreadystatechange = function () {
            if (!this.readyState || this.readyState === "loaded" || this.readyState ===
                "complete")b(), c.onload = c.onreadystatechange = null, c.parentNode && c.parentNode.removeChild(c)
        };
        c.src = a;
...
$.browser = function (a) {
    if (typeof $.browser.info == "undefined") {
        var b = {type: ""}, c = navigator.userAgent.toLowerCase();
        /webkit/.test(c) ? b = {type: "webkit", version: /webkit[\/ ]([\w.]+)/} : /opera/.test(c) ? b = {type: "opera", version: /version/.test(c) ? /version[\/ ]([\w.]+)/ : /opera[\/ ]([\w.]+)/} : /msie/.test(c) ? b = {type: "msie", version: /msie ([\w.]+)/} : /mozilla/.test(c) && !/compatible/.test(c) && (b = {type: "ff", version: /rv:([\w.]+)/});
...
$.e = {_counter: 0, _uid: function () {
    ...
    typeof a != "object" && (a = $(a));
    if (document.addEventListener)a.addEventListener(b, c, false); else if (document.attachEvent && $.e._find(a, b, c) == -1) {
        var d = function (b) {
            if (!b)b = window.event;
            b = {_event: b, type: b.type, target: b.srcElement, currentTarget: a, relatedTarget: b.fromElement ? b.fromElement : b.toElement, eventPhase: b.srcElement == a ? 2 : 3, clientX: b.clientX, clientY: b.clientY, screenX: b.screenX, screenY: b.screenY, altKey: b.altKey, ctrlKey: b.ctrlKey,
                shiftKey: b.shiftKey, keyCode: b.keyCode, stopPropagation: function () {
        ...
        var b = {element: a, eventType: b, handler: c, wrappedHandler: d}, d = (a.document || a).parentWindow, f = $.e._uid();
        if (!d._allHandlers)d._allHandlers = {};
        d._allHandlers[f] = b;
        if (!a._handlers)a._handlers = [];
        a._handlers.push(f);
        if (!d._onunloadHandlerRegistered)d._onunloadHandlerRegistered =
            true, d.attachEvent("onunload", $.e._removeAllHandlers)
    }
}, remove: function (a, b, c) {
    if (document.addEventListener)a.removeEventListener(b, c, false); else if (document.attachEvent && (c = $.e._find(a, b, c), c != -1)) {
        var d = (a.document || a).parentWindow, f = a._handlers[c];
...
$.dom = {init: function () {
    ...
    if (document.documentElement && document.documentElemnet.scrollWidth)$.dom.getDocumentWidth =
        function () {
    ...
    if (this.getFinalStyle(a, "display") !==
        "none")return a.offsetHeight || a.clientHeight; else {
    ...
    if (this.getFinalStyle(a, "display") !== "none")return a.offsetWidth || a.clientWidth; else {
        a.style.display = "block";
    ...
    getPageHeight: function () {
        ...
        var c = document.createElement(a), d = {"class": function () {
            c.className = b["class"]
        }, style: function () {
            c.style.cssText = b.style
        }}, f;
        for (f in b)if (d[f])d[f](); else c.setAttribute(f, b[f]);
        return c
    }};
$.css = {hasClass: function (a, b) {
...
$.str = {getBytes: function (a) {
    return a.replace(/[^\x00-\xff]/g, "xx").length
}};
$.html = {encode: function (a) {
    var b = "";
...
$.oop = {extend: function (a) {
    ...
    if (a === 2) {
        var a = arguments[0].extend, d = function () {
        };
        d.prototype = a.prototype;
        c.superClass = a.prototype;
        c.callSuper = function (a, b) {
            var d = Array.prototype.slice, h = d.call(arguments, 2);
    ...
    if (c) {
        ...
        for (var a = a._$events[b], b = -1, d = 0, f = a.length; d < f; d++)if (a[d] ==
            c) {
            b = d;
            break
        }
...
g = {searchValue: "\u8f93\u5165\u60f3\u8981\u76844-10\u4f4d\u6570\u5b57", searchTip: "\u8bf7\u8f93\u51654-10\u4f4d\u6570\u5b57", cacheUrl: "", ver: 10062, component: {}, searchBlur: function (a) {
    ...
    a ? ($("quickReg").style.display = "block", $("switcher").className = "hover", $.report.monitor("phone_zc")) : ($("quickReg").style.display = "none", $("switcher").className =
        "normal")
}, formSubmit: function () {
    if (/^[0-9]{4,10}$/.test($("serch_ipt").value))window.open("http://haoma.qq.com/shop.html#num=" + $("serch_ipt").value + "&from=zc"); else return alert(g.searchTip), false;
    ...
    try {
        if (window.ActiveXObject) {
            var a = new ActiveXObject("SSOAxCtrlForPTLogin.SSOForPTLogin2"), b = a.CreateTXSSOData();
            a.InitSSOFPTCtrl(0, b);
            var c = a.CreateTXSSOData(), d = a.DoOperation(2, c).GetArray("PTALIST").GetSize();
            if (d > 0)return d
...
$.report = {id2attr: {submit: {id: 173272, tag: "0xD001"}, guard: {id: 173273, tag: "0xD002"}, sendToLocal: {id: 173274}, sendToEmail: {id: 173275}, numReg: {id: 173276}, phoneReg: {id: 239277}, QQMailReg: {id: 173277}, otherMailReg: {id: 173278}, pv: {id: 173279}, pv_all: {id: 260714}, pv_chs: {id: 278037}, pv_cht: {id: 278038}, pv_en: {id: 278039}, verifyChangeTel: {id: 239278}, verifyUpChangeTel: {id: 239279}, hasbindChangeTel: {id: 239280}, tianyiChangeTel: {id: 239281}, paopao: {id: 239282}, phoneRegSubmitBtn: {id: 241143}, phoneGetVerimaBtn: {id: 241144},
    ...
    for (var b =
        [1, 2, 3, 4], c = ["http://isdspeed.qq.com/cgi-bin/r.cgi?flag1=7817&flag2=2&flag3=3"], d = 0, f = b.length; d < f; d++)a[d] > 0 && (c.push("&"), c.push(b[d]), c.push("="), c.push(a[d]));
    $.http.preload(c.join(""))
}};
...
function feedBack(a) {
    var a = 716, b = $.cookie.get("sessionCookie"), c = $.cookie.get("machineCookie"), d = $.cookie.get("skey"), f = $.cookie.get("uin"), e = "";
...
(function () {
    $.cookie.get("nohost_guid") != "" && $.http.loadScript("/nohost_htdocs/js/SwitchHost.js", function () {
        var a = window.SwitchHost && window.SwitchHost.init;
        a && a()
    })
})();
$.e.add(window, "load", function () {
