...
;
Object.extend_p(Event, {observers: false, element: function (event) {
...
Popup.prototype = {
        ...
        if (val != '') {
            switch (arrt) {
                ...
                case 'overlay':
                    ...
                    break;
                case 'framename':
                    this.info.framename = val;
                    break;
                case 'boxstyle':
                    this.config.boxstyle = val;
                    break;
            }
            ;
        }
    ...
    build: function () {
        ...
        if (this.info.title == undefined || this.info.title == null) {
            this.info.title = "";
        }
