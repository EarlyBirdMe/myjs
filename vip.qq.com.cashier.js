(function () {
    ...
    Dialog.prototype._render = function () {
        ...
        CAV._ready.onReady(function () {
            ...
            if (_this.quiet) {
                ...
                dialogMask.style.cssText = (targetNode) ? "" : ["left:", pos.x, "px;top:", pos.y, "px;width:", sizeDialog.w, "px;height:", sizeDialog.h, "px;"].join("");
    ...
    Dialog.prototype.quit = function () {
        ...
        LIB.setTimeout(function () {
            ...
            document.body.removeChild(this.dialogBody)
        }, 2000, this)
    };
...
/*  |xGv00|fdf47068c25ddca0bcb4fec8533a0e5a */